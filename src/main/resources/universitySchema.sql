...
CREATE TABLE `education_programmes` (
  ...
  CONSTRAINT `education_programmes_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  CONSTRAINT `education_programmes_ibfk_2` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`)
...
-- Dump completed on 2016-10-09 13:02:40
